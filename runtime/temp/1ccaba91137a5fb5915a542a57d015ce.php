<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp64\www\cdyy\public/../application/register\view\index\check.html";i:1521472746;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <script>
            function resend() {
                ...
                hrefDom.onclick = "";
                var $ = layui.$;
                $.post("/register/index/resend", { mail: "test@qq.com"} );
                setTimeout('ok()', 60000);
            }
            function ok() {
                var hrefDom = document.getElementById("rebtn");
