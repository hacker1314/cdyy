<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp64\www\tp\public/../application/admin\view\building\index.html";i:1520065877;s:57:"D:\wamp64\www\tp\application\admin\view\index\header.html";i:1519551429;s:57:"D:\wamp64\www\tp\application\admin\view\index\footer.html";i:1519441589;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
        ...
        <ul class="layui-nav layui-nav-tree"  lay-filter="test">
            ...
            <li class="layui-nav-item">
                <a class="" href="<?php echo url('admin/building/index'); ?>"><i class='layui-icon'>&#xe715;</i>学生活动场地</a>
            </li>
            <li class="layui-nav-item layui-nav-itemed">
...
<script type="text/html" id="titleTpl">
    <a href="javascript:void(0);" onclick='showpic("{{d.id}}")' class="layui-table-link">查看照片</a>
</script>
<script>
//JavaScript代码区域
    ...
    table.render({
    elem: '#buildingmanage'
            , url: '/admin/building/buildinglist'
            , cols: [[
            {field: 'id', width: 80, minWidth: 80, title: 'ID', sort: true}
            , {field: 'name', minWidth: 120, title: '场地名'}
            , {field: 'introduction', minWidth: 170, title: '简介'}
            , {field: 'status', minWidth: 170, title: '可否预约'}
            , {field: 'pictureurl', minWidth: 130, title: '照片', templet: '#titleTpl'}
