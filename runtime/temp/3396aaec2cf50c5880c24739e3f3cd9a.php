<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp64\www\tp\public/../application/admin\view\buildings\index.html";i:1520067586;s:57:"D:\wamp64\www\tp\application\admin\view\index\header.html";i:1519551429;s:57:"D:\wamp64\www\tp\application\admin\view\index\footer.html";i:1519441589;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
//JavaScript代码区域
    ...
    elem: '#buildingmanage'
            ...
            , {field: 'status', minWidth: 90, title: '可否预约', templet: '#statusTpl'}
            , {field: 'pictureurl', minWidth: 90, title: '照片', templet: '#picTpl'}
...
<script>
    ...
    type: 1
    ,title:'查看图片'
    ,content: '<img src="' + pic + '" alt="some_text">' //这里content是一个普通的String
    ,anim:'2'
    ,area: ['300px', '300px']
    ,time: 5000
            });
