<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wamp64\www\tp\public/../application/index\view\admin\login.html";i:1519355778;}*/ ?>
                    ...
                    <link rel="stylesheet" type="text/css" href="/static/admin_login/userpanel.css">
                        <link rel="stylesheet" type="text/css" href="/static/admin_login/jquery.ui.all.css">
                            ...
                            <body class="login" mycollectionplug="bind">
                                <form name="input" action="<?php echo url('index/admin/logincheck'); ?>" method="post">
                                    <div class="login_m" style="height: 500px;">
                                        <div class="login_logo"><img src="/static/admin_login/logo.png" width="300" height="46"></div>
