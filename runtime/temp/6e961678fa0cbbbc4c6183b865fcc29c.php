<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\xampp\htdocs\cdyy\public/../application/admin\view\place\editp.html";i:1521073915;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <form class="layui-form layui-form-pane" action="<?php echo url('admin/place/editpl'); ?>" style="margin-left: 20px;margin-right: 20px;margin-top: 20px;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="placename" required  lay-verify="required" placeholder="请输入场地名" autocomplete="off" class="layui-input" value="<?php echo $placename; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">场地类型：</label>
                <div class="layui-input-block">
                    <input type="text" name="child" required  lay-verify="required" placeholder="请输入子场地数量" autocomplete="off" class="layui-input" value="<?php echo $child; ?>">
                </div>
            </div>
            <div class="layui-form-item layui-hide" >
                <label class="layui-form-label">场地类型：</label>
