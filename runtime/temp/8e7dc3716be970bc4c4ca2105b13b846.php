...
<html>
    ...
    <body>
        ...
        <div style="background-image: url(/static/login/bg.png); background-size:cover; min-width:1024px;height: 980px">
            ...
            <div style=" background-color: #FfFfFf; margin-left:auto;margin-right:auto; height: 800px;width: 1000px">
                ...
                <form class="layui-form " action="/register/index/check" method="get" style="margin-left:auto;margin-right:auto;width: 500px">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="xh" required lay-verify="required|username" placeholder="请输入个人学号" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">请填写个人学号</div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">学院：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="xy" required lay-verify="required|username" placeholder="请输入所属学院" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">请填写学院</div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">专业：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="zy" required lay-verify="required|username" placeholder="请输入个人专业" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">请填写个人专业</div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">社团：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="st" required lay-verify="required|username" placeholder="请输入所属社团" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">请填写社团名</div>
                    </div>
                    <div class="layui-form-item">
