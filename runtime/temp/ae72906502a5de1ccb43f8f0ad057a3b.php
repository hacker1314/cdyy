<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\tp\public/../application/admin\view\usermanage\index.html";i:1519824331;s:57:"D:\wamp64\www\tp\application\admin\view\index\header.html";i:1519551429;s:57:"D:\wamp64\www\tp\application\admin\view\index\footer.html";i:1519441589;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/html" id="barDemo">
    ...
    <!-- 这里同样支持 laytpl 语法，如： -->
    {{#  if(d.auth > 2){ }}
    <a class="layui-btn layui-btn-xs" lay-event="ch22eck">解禁</a>
    {{#  } }}
</script>
...
layui.use(['layer', 'element', 'table'], function () {
    ...
    table.render({
        ...
        , cols: [[
                ...
                , {field: 'status', width: 100, title: '用户状态', sort: true}
