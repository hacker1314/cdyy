<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp64\www\cdyy\public/../application/admin\view\art\adda.html";i:1520669413;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        <form class="layui-form layui-form-pane" action="<?php echo url('admin/art/addar'); ?>" style="margin-left: 20px;margin-right: 20px;margin-top: 20px;">
